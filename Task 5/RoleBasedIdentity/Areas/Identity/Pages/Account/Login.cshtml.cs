...
namespace TimeMate.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<TimeMateUser> signInManager, ILogger<LoginModel> logger,UserManager<TimeMateUser> userManager,TimeMateContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("Create","Goal");
                    }
